...
<body>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/decorr.jpg" alt="Interior Design">
    </section>
    ...
    <section class="gallery">
        ...
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/glitter.jpg" alt="Glitter"><span>Glitter</span></a>
            <a href="page2.html" class="image-box"><img src="img/cinnamon.jpeg" alt="Cinnamon"><span>Cinnamon</span></a>
            <a href="page3.html" class="image-box"><img src="img/lasagne.jpg" alt="Lasagne"><span>Lasagne</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/pesto.jpg", alt: "Pesto", link: "page4.html" },
            { src: "img/klasay.jpg", alt: "Klasay", link: "page5.html" },
            { src: "img/dirmatt.jpg", alt: "Dirmatt", link: "page6.html" }
        ],
        [
            { src: "img/papua.jpg", alt: "Papua", link: "page7.html" },
            { src: "img/vosgas.jpeg", alt: "Vosgas", link: "page8.html" },
            { src: "img/crossfire.jpg", alt: "Crossfire", link: "page9.html" }
        ],
        [
            { src: "img/savannah.jpg", alt: "Savannah", link: "page7.html" },
            { src: "img/comedk.jpg", alt: "Comedk", link: "page8.html" },
            { src: "img/alaskan.jpg", alt: "Alaskan", link: "page9.html" }
        ],
        [
            { src: "img/nubuck.jpg", alt: "Nubuck", link: "page7.html" }
        ]
    ];
