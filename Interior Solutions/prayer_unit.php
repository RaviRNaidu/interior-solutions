...
<body>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/prayer.jpg" alt="Interior Design">
    </section>
    ...
    <section class="gallery">
        ...
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/laquat.jpg" alt="Laquat"><span>Laquat</span></a>
            <a href="page2.html" class="image-box"><img src="img/cassia1.jpg" alt="Cassia"><span>Cassia</span></a>
            <a href="page3.html" class="image-box"><img src="img/cacao.jpg" alt="Cacao"><span>Cacao</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/dindle.jpg", alt: "Dindle", link: "page4.html" },
            { src: "img/nova.jpg", alt: "Nova", link: "page5.html" },
            { src: "img/birch.jpg", alt: "Birch", link: "page6.html" }
        ],
        [
            { src: "img/aspen1.jpg", alt: "Aspen", link: "page7.html" },
            { src: "img/bole.jpg", alt: "Bole", link: "page8.html" },
            { src: "img/bistre.jpg", alt: "Bistre", link: "page9.html" }
        ],
        [
            { src: "img/nubuck1.jpg", alt: "Nubuck", link: "page7.html" },
            { src: "img/ferns.jpg", alt: "Ferns", link: "page8.html" },
            { src: "img/venza.jpg", alt: "Venza", link: "page9.html" }
        ],
        [
            { src: "img/hawthorn.jpg", alt: "Hawthorn", link: "page7.html" },
            { src: "img/choco.jpg", alt: "Choco", link: "page8.html" },
            { src: "img/chimera.jpg", alt: "Chimera", link: "page9.html" }
        ]
    ];
