...
<header>
    ...
    const newImagesSet = [
        [
            { src: "img/carlton.jpg", alt: "Carlton", link: "page4.html" },
            { src: "img/sappy.jpg", alt: "Sappy", link: "page5.html" },
            { src: "img/anegre.jpg", alt: "Anegre", link: "page6.html" }
        ],
        [
            { src: "img/sapeli.jpg", alt: "Sapeli", link: "page7.html" },
            { src: "img/brunette.jpg", alt: "Brunette", link: "page8.html" },
            { src: "img/pine.jpg", alt: "Pine", link: "page9.html" }
        ],
        [
            { src: "img/macaroon.jpg", alt: "Macaroon", link: "page7.html" },
            { src: "img/onyx.jpg", alt: "Onyx", link: "page8.html" },
            { src: "img/charcoal.jpg", alt: "Charcoal", link: "page9.html" }
        ],
        [
            { src: "img/graphite.jpg", alt: "Graphite", link: "page7.html" },
            { src: "img/canary.jpg", alt: "Canary", link: "page8.html" },
        ]   
    ];
