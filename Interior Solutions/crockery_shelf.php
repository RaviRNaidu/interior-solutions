...
<header>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/vietnamese.jpg" alt="Interior Design">
    </section>

    <!-- Scrollable Section -->
    <section class="gallery">
        <h2>Crockery Shelf</h2>
        <p>A crockery shelf enables you to arrange your crockery items in a prestigious way. Dining rooms will be beautified when you have a customized crockery shelf in it. Choose from the wide range of crockery shelf designs from Interior Solutions.</p>
        
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/tahiti.jpg" alt="Tahiti"><span>Tahiti</span></a>
            <a href="page2.html" class="image-box"><img src="img/siberian.jpg" alt="Siberian"><span>Siberian</span></a>
            <a href="page3.html" class="image-box"><img src="img/scandinavian.jpg" alt="Scandinavian"><span>Scandinavian</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/vietnamese.jpg", alt: "Vietnamese", link: "page4.html" },
            { src: "img/malagasi.jpg", alt: "Malagasi", link: "page5.html" },
            { src: "img/helsinki.jpg", alt: "Helsinki", link: "page6.html" }
        ],
        [
            { src: "img/sangria.jpg", alt: "Sangria", link: "page7.html" }
        ]
    ];
