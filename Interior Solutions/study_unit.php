...
<body>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/kidsstudy.jpg" alt="Interior Design">
    </section>
    ...
    <section class="gallery">
        ...
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/meadow.jpg" alt="Meadow"><span>Meadow</span></a>
            <a href="page2.html" class="image-box"><img src="img/saffron.jpg" alt="Saffron"><span>Saffron</span></a>
            <a href="page3.html" class="image-box"><img src="img/prairie.jpg" alt="Prairie"><span>Prairie</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/aurbun.jpg", alt: "Aurbun", link: "page4.html" },
            { src: "img/arctic.jpg", alt: "Arctic", link: "page5.html" },
            { src: "img/espanu.jpg", alt: "Espanu", link: "page6.html" }
        ],
        [
            { src: "img/poppy.jpg", alt: "Poppy", link: "page7.html" },
            { src: "img/seda.jpg", alt: "Seda", link: "page8.html" },
            { src: "img/mistic.jpg", alt: "Mistic", link: "page9.html" }
        ],
        [
            { src: "img/arendal.jpg", alt: "Arendal", link: "page10.html" },
            { src: "img/shangrila.jpg", alt: "Shangrila", link: "page11.html" }
        ]
    ];
