...
<body>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/barcounter1.jpg" alt="Interior Design">
    </section>

    <!-- Scrollable Section -->
    <section class="gallery">
        <h2>BAR COUNTER</h2>
        <p>Most of the modern houses have a bar counter unit assembled at the dining room itself. It not only serves as a bar counter unit, but also acts as a prestigious decorative unit too. Avail the bar counter units to be assembled anywhere in Kerala, Bangalore, Mysore, Hyderabad, Coimbatore, Chennai, Mangalore and Nagercoil from Interior Solutions Home Interiors.</p>
        
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/plush.png" alt="Plush"><span>Plush</span></a>
            <a href="page2.html" class="image-box"><img src="img/bursa.jpg" alt="Bursa"><span>Bursa</span></a>
            <a href="page3.html" class="image-box"><img src="img/bavarian.jpg" alt="Bavarian"><span>Bavarian</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/borneo.jpeg", alt: "Borneo", link: "page4.html" },
            { src: "img/accassia.jpg", alt: "Accassia", link: "page5.html" },
            { src: "img/aegan.jpg", alt: "Aegan", link: "page6.html" }
        ],
        [
            { src: "img/pickle.jpg", alt: "Pickle", link: "page7.html" },
            { src: "img/honey.jpg", alt: "Honey", link: "page8.html" },
            { src: "img/bumblebee.jpg", alt: "Bumblebee", link: "page9.html" }
        ],
        [
            { src: "img/crocodile.jpg", alt: "Crocodile", link: "page7.html" },
            { src: "img/plum.jpg", alt: "Plum", link: "page8.html" },
            { src: "img/dandelion.jpg", alt: "Dandelion", link: "page9.html" }
        ],
        [
            { src: "img/raven.jpg", alt: "Raven", link: "page7.html" },
            { src: "img/cerulean.jpg", alt: "Cerulean", link: "page8.html" },
            { src: "img/ginger.jpg", alt: "Ginger", link: "page9.html" }
        ],
        [
            { src: "img/lime.jpg", alt: "Lime", link: "page7.html" },
            { src: "img/amethyst.jpg", alt: "Amethyst", link: "page8.html" }
        ]
    ];
