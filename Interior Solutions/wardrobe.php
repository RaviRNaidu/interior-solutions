...
<header>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/wardrobe1.jpg" alt="Interior Design">
    </section>
    ...
    <section class="gallery">
        ...
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/cantaloupe.jpg" alt="Cantaloupe"><span>Cantaloupe</span></a>
            <a href="page2.html" class="image-box"><img src="img/pears.jpg" alt="Pears"><span>Pears</span></a>
            <a href="page3.html" class="image-box"><img src="img/lemur.jpg" alt="Lemur"><span>Lemur</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/bunch.jpg", alt: "Bunch", link: "page4.html" },
            { src: "img/bisque1.jpg", alt: "Bisque", link: "page5.html" },
            { src: "img/recon.jpg", alt: "Recon", link: "page6.html" }
        ],
        [
            { src: "img/diakon.jpg", alt: "Diakon", link: "page7.html" },
            { src: "img/pumpkin.jpg", alt: "Pumpkin", link: "page8.html" },
            { src: "img/octopus.jpg", alt: "Octopus", link: "page9.html" }
        ],
        [
            { src: "img/ambarella.jpg", alt: "Ambarella", link: "page7.html" },
            { src: "img/balsam.jpg", alt: "Balsam", link: "page8.html" },
            { src: "img/taupe.jpg", alt: "Taupe", link: "page9.html" }
        ],
        [
            { src: "img/ridged.jpg", alt: "Ridged", link: "page7.html" },
            { src: "img/raisin.jpg", alt: "Raisin", link: "page8.html" },
            { src: "img/betel.jpg", alt: "Betel", link: "page9.html" }
        ],
        [
            { src: "img/slate.jpg", alt: "Slate", link: "page7.html" },
            { src: "img/sandpiper.jpg", alt: "Sandpiper", link: "page8.html" },
            { src: "img/gibbon.jpg", alt: "Gibbon", link: "page9.html" }
        ]
    ];
