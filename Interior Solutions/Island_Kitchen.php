...
<header>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/kitchen2.jpg" alt="Interior Design">
    </section>

    <!-- Scrollable Section -->
    <section class="gallery">
        <h2>Island Kitchen</h2>
        <p>Kitchens should be elegant looking as well as serve our purpose of storage, convenient cooking, and a part of comfortable living. Island kitchen series of modern designs from Interior Solutions offers you a wide range of selections to help the customer get the best idea. These are different from the traditional style and towards the new trends. Some of these models are displayed in our showrooms. Sandy, orchid, mauve, ivory, niagara, excalibur etc are some of the samples under island kitchens.</p>
        
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/axolotl1.jpg" alt="Axolotl"><span>Axolotl</span></a>
            <a href="page2.html" class="image-box"><img src="img/avocado.jpg" alt="Avocado"><span>Avocado</span></a>
            <a href="page3.html" class="image-box"><img src="img/amethyst.jpg" alt="Amethyst"><span>Amethyst</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/aureolin.jpg", alt: "Aureolin", link: "page4.html" },
            { src: "img/auburn.jpg", alt: "Auburn", link: "page5.html" },
            { src: "img/cypress.jpg", alt: "Cypress", link: "page6.html" }
        ],
        [
            { src: "img/bark.jpg", alt: "Bark", link: "page7.html" },
            { src: "img/niagara.jpg", alt: "Niagara", link: "page8.html" },
            { src: "img/orchid.jpg", alt: "Orchid", link: "page9.html" }
        ]
    ];
