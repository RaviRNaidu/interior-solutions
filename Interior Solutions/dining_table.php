...
<body>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/diningtable.jpg" alt="Interior Design">
    </section>

    <!-- Scrollable Section -->
    <section class="gallery">
        <h2>Dining Table</h2>
        <p>As the dining table is a prominent piece of furniture for the daily use of family members, its style and durability is a matter of concern for all. Interior Solutions makes suitable dining tables as part of home interior projects undertaken. Most modern styles can be integrated into the durable materials of laminated hardwood fiber board and glass. Ask for the available types of dining table or let us create something new for your house or flat.</p>
        
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/vanessa.jpg" alt="Vanessa"><span>Vanessa</span></a>
            <a href="page2.html" class="image-box"><img src="img/copperlattice.jpg" alt="Copper Lattice"><span>Copper Lattice</span></a>
            <a href="page3.html" class="image-box"><img src="img/copperfinish.jpg" alt="Copper Finish"><span>Copper Finish</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/tangle.jpg", alt: "Tangle", link: "page4.html" },
            { src: "img/medley.jpg", alt: "Medley", link: "page5.html" },
            { src: "img/canary1.jpg", alt: "Canary", link: "page6.html" }
        ],
        [
            { src: "img/flamingo.jpg", alt: "Flamingo", link: "page7.html" },
            { src: "img/indigo.jpg", alt: "Indigo", link: "page8.html" },
            { src: "img/medallion.jpg", alt: "Medallion", link: "page9.html" }
        ],
        [
            { src: "img/pebble.jpg", alt: "Pebble", link: "page7.html" },
            { src: "img/squash.jpg", alt: "Squash", link: "page8.html" }
        ]
    ];
