...
<header>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/chair.jpg" alt="Interior Design">
    </section>

    <!-- Scrollable Section -->
    <section class="gallery">
        <h2>Dining Chair</h2>
        <p>Dining chairs of the most modern type are custom-designed and made to suit the dining table set. Complete home interiors in unique style would need attention to even the small things. An alternative option is to go for a ready-made dining table and chairs set. But that may not match with the rest of the works that lead to imperfection. With Interior Solutions customized dining chairs it is sure to bring comfort and style in perfect combination with the rest of the furnishing.</p>
        
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/helenic.jpg" alt="Helenic"><span>Helenic</span></a>
            <a href="page2.html" class="image-box"><img src="img/tundra.jpg" alt="Tundra"><span>Tundra</span></a>
            <a href="page3.html" class="image-box"><img src="img/bournville.jpg" alt="Bournville"><span>Bournville</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/montana.jpg", alt: "Montana", link: "page4.html" },
            { src: "img/khaya.jpg", alt: "Khaya", link: "page5.html" },
            { src: "img/acacia.jpg", alt: "Acacia", link: "page6.html" }
        ]
    ];
