...
<body>
    ...
    <section class="gallery">
        ...
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/banana.jpg" alt="Banana"><span>Banana</span></a>
            <a href="page2.html" class="image-box"><img src="img/boysenberry.jpg" alt="Boysenberry"><span>Boysenberry</span></a>
            <a href="page3.html" class="image-box"><img src="img/bubblegum.jpg" alt="Bubblegum"><span>Bubblegum</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/champagne.jpg", alt: "Champagne", link: "page4.html" },
            { src: "img/iris.jpg", alt: "Iris", link: "page5.html" },
            { src: "img/shore.jpg", alt: "Shore", link: "page6.html" }
        ]
    ];
