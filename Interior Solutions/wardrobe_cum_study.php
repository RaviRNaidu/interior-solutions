...
<head>
    ...
    <title>Wardrobe_Cum_Study_Table</title>
...
<body>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/kidswall1.jpg" alt="Interior Design">
    </section>
    ...
    <section class="gallery">
        ...
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/carnival.jpg" alt="Carnival"><span>Carnival</span></a>
            <a href="page2.html" class="image-box"><img src="img/auburn1.jpg" alt="Auburn"><span>Auburn</span></a>
            <a href="page3.html" class="image-box"><img src="img/fiesta.jpg" alt="Fiesta"><span>Fiesta</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/cambric.jpg", alt: "Cambric", link: "page4.html" },
            { src: "img/kidswall.jpg", alt: "Chestnut", link: "page5.html" },
            { src: "img/catawba.jpg", alt: "Catawba", link: "page6.html" }
        ]
    ];
