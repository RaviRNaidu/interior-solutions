...
<header>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/bedroom.jpg" alt="Interior Design">
    </section>
    ...
    <section class="gallery">
        ...
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/wainscoting.jpeg" alt="Wainscoting"><span>Wainscoting</span></a>
            <a href="page2.html" class="image-box"><img src="img/montreal.jpg" alt="Montreal"><span>Montreal</span></a>
            <a href="page3.html" class="image-box"><img src="img/primrose.jpg" alt="Primrose"><span>Primrose</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/hanoi.jpg", alt: "Hanoi", link: "page4.html" },
            { src: "img/tasmania.jpg", alt: "Tasmania", link: "page5.html" },
            { src: "img/salvation.jpg", alt: "Salvation", link: "page6.html" }
        ],
        [
            { src: "img/morocco.jpeg", alt: "Morocco", link: "page7.html" },
            { src: "img/dallol.jpg", alt: "Dallol", link: "page8.html" },
            { src: "img/arizona1.jpg", alt: "Arizona", link: "page9.html" }
        ],
        [
            { src: "img/havana.jpeg", alt: "Havana", link: "page7.html" },
            { src: "img/campion.jpg", alt: "Campion", link: "page8.html" },
            { src: "img/belleza.jpg", alt: "Belleza", link: "page9.html" }
        ],
        [
            { src: "img/bliss.jpg", alt: "Bliss", link: "page7.html" },
            { src: "img/milky.jpg", alt: "Milky", link: "page8.html" },
            { src: "img/umber.jpg", alt: "Umber", link: "page9.html" }
        ],
        [
            { src: "img/grey.jpg", alt: "Grey", link: "page7.html" },
            { src: "img/mocha.jpg", alt: "Mocha", link: "page8.html" },
            { src: "img/legoland.jpg", alt: "Legoland", link: "page9.html"}
        ],
        [
            { src: "img/sintra.jpg", alt: "Sintra", link: "page7.html" },
            { src: "img/scratch.jpg", alt: "Scratch", link: "page8.html" },
            { src: "img/rafflesia.jpg", alt: "Rafflesia", link: "page9.html" }
        ]
    ];
