...
<header>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/lshapekitchen2.jpg" alt="Interior Design">
    </section>

    <!-- Scrollable Section -->
    <section class="gallery">
        <h2>L Shape Kitchen</h2>
        <p>Kitchen of a house should be made and maintained in proper shape, design and color. Everything should be arranged perfectly to match the requirements. L-shaped kitchens from Interior Solutions are 100% customized to fit the space. Various options are given below which can further be modified and made as per a design finalized. These L shape kitchen models are available to visit and view in our showrooms across South India. Beige, cocoa, cedar, cyclone, ebony, talisman etc. are some of the samples under L shape.</p>
        
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/talisman.jpg" alt="Talisman"><span>Talisman</span></a>
            <a href="page2.html" class="image-box"><img src="img/cyclone.jpg" alt="Cyclone"><span>Cyclone</span></a>
            <a href="page3.html" class="image-box"><img src="img/ebony.jpg" alt="Ebony"><span>Ebony</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/sapphire.jpg", alt: "Sapphire", link: "page4.html" },
            { src: "img/sunray.jpg", alt: "Sunray", link: "page5.html" },
            { src: "img/harlequin.jpg", alt: "Harlequin", link: "page6.html" }
        ],
        [
            { src: "img/erin.jpg", alt: "Erin", link: "page7.html" },
            { src: "img/arizona.jpg", alt: "Arizona", link: "page8.html" },
            { src: "img/licorice.jpg", alt: "Licorice", link: "page9.html" }
        ],
        [
            { src: "img/beige.jpg", alt: "Beige", link: "page7.html" },
            { src: "img/wave.jpg", alt: "Wave", link: "page8.html" },
            { src: "img/cocoa.jpg", alt: "Cocoa", link: "page9.html" }
        ],
        [
            { src: "img/peru.jpg", alt: "Peru", link: "page7.html" },
            { src: "img/amber.jpg", alt: "Amber", link: "page8.html" },
            { src: "img/snow.jpg", alt: "Snow", link: "page9.html" }
        ]
    ];
