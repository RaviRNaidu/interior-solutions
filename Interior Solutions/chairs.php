...
<body>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/chairs1.jpg" alt="Interior Design">
    </section>
    ...
    <section class="gallery">
        ...
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/zebrano.jpg" alt="Zebrano"><span>Zebrano</span></a>
            <a href="page2.html" class="image-box"><img src="img/marigold.jpg" alt="Marigold"><span>Marigold</span></a>
            <a href="page3.html" class="image-box"><img src="img/onyx1.jpg" alt="Onyx"><span>Onyx</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/zambezi.jpeg", alt: "Zambezi", link: "page4.html" },
            { src: "img/pompei.jpg", alt: "Pompei", link: "page5.html" },
            { src: "img/linosa.jpg", alt: "Linosa", link: "page6.html" }
        ],
        [
            { src: "img/zanskar.jpg", alt: "Zanskar", link: "page7.html" }
        ]
    ];
