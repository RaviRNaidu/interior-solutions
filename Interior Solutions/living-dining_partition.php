...
<head>
    ...
    <title>Living-Dining Partition</title>
...
<body>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/livingdining.jpg" alt="Interior Design">
    </section>

    <!-- Scrollable Section -->
    <section class="gallery">
        <h2>Living-Dining Partition</h2>
        <p>Living- Dining Partition Design is done with 2 purposes. One is to prevent the direct view of dining from the living side and another is to add wood touch beautification where an opportunity is found. This may work as a showcase to display some artistic things. Interior Solutions will make the partition stylish and suitable to the space available. Discuss with our designer while discussing interior works for your home.</p>
        
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/gladiola.jpg" alt="Gladiola"><span>Gladiola</span></a>
            <a href="page2.html" class="image-box"><img src="img/heena.jpg" alt="Heena"><span>Heena</span></a>
            <a href="page3.html" class="image-box"><img src="img/emerald.jpg" alt="Emerald"><span>Emerald</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/brick.jpg", alt: "Brick", link: "page4.html" },
            { src: "img/cider.jpg", alt: "Cider", link: "page5.html" },
            { src: "img/daffodil.jpg", alt: "Daffodil", link: "page6.html" }
        ],
        [
            { src: "img/lavender.jpg", alt: "Lavender", link: "page7.html" },
            { src: "img/oat.jpg", alt: "Oat", link: "page8.html" },
            { src: "img/pearl1.jpg", alt: "Pearl", link: "page9.html" }
        ],
        [
            { src: "img/frostbite.jpeg", alt: "Frostbite", link: "page7.html" },
            { src: "img/flint.jpg", alt: "Flint", link: "page8.html" },
            { src: "img/anchor.jpg", alt: "Anchor", link: "page9.html" }
        ],
        [
            { src: "img/ruby.jpg", alt: "Ruby", link: "page7.html" },
            { src: "img/tuscan.jpg", alt: "Tuscan", link: "page8.html" },
            { src: "img/crimson.jpg", alt: "Crimson", link: "page9.html" }
        ],
        [
            { src: "img/jaisalmer.jpg", alt: "Jaisalmer", link: "page7.html" },
            { src: "img/raspberry.jpg", alt: "Raspberry", link: "page8.html" }
        ]
    ];
