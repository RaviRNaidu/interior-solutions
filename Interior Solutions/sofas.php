...
<body>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/sofas1.jpg" alt="Interior Design">
    </section>
    ...
    <section class="gallery">
        ...
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/lemy.jpg" alt="Lemy"><span>Lemy</span></a>
            <a href="page2.html" class="image-box"><img src="img/debonair.jpg" alt="Debonair"><span>Debonair</span></a>
            <a href="page3.html" class="image-box"><img src="img/ottoman.jpg" alt="Ottoman Bench"><span>Ottoman Bench</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/cornsilk.jpg", alt: "Cornsilk", link: "page4.html" },
            { src: "img/hunter.jpg", alt: "Hunter", link: "page5.html" },
            { src: "img/aspen.jpg", alt: "Aspen", link: "page6.html" }
        ],
        [
            { src: "img/travertine.jpeg", alt: "Travertine", link: "page7.html" },
            { src: "img/aluwave.jpg", alt: "Aluwave", link: "page8.html" },
            { src: "img/doodle.jpg", alt: "Doodle", link: "page9.html" }
        ]
    ];
