...
<header>
    ...
    const newImagesSet = [
        [
            { src: "img/parakeet.jpg", alt: "Parakeet", link: "page4.html" },
            { src: "img/crescent.jpg", alt: "Crescent", link: "page5.html" },
            { src: "img/mint.jpg", alt: "Mint", link: "page6.html" }
        ],
        [
            { src: "img/turmeric.jpg", alt: "Turmeric", link: "page7.html" },
            { src: "img/parallelkitchen1.jpg", alt: "Misty", link: "page8.html" },
            { src: "img/pearl.jpg", alt: "Pearl", link: "page9.html" }
        ],
        [
            { src: "img/coral.jpg", alt: "Coral", link: "page7.html" },
            { src: "img/chestnut.jpg", alt: "Chestnut", link: "page8.html" }
        ]
    ];
