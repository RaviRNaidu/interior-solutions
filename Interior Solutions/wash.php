...
<header>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/wash.jpg" alt="Interior Design">
    </section>
    ...
    <section class="gallery">
        ...
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/crepe.jpg" alt="Crepe"><span>Crepe</span></a>
            <a href="page2.html" class="image-box"><img src="img/wisdom.jpg" alt="Wisdom"><span>Wisdom</span></a>
            <a href="page3.html" class="image-box"><img src="img/hardrock.jpg" alt="Hardrock"><span>Hardrock</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/alberta.jpg", alt: "Alberta", link: "page4.html" },
            { src: "img/alpine.jpg", alt: "Alpine", link: "page5.html" },
            { src: "img/arosa.jpg", alt: "Arosa", link: "page6.html" }
        ],
        [
            { src: "img/alabaster.jpg", alt: "Alabaster", link: "page7.html" },
            { src: "img/basil.jpg", alt: "Basil", link: "page8.html" },
            { src: "img/coral1.jpg", alt: "Coral", link: "page9.html" }
        ],
        [
            { src: "img/fog.jpg", alt: "Fog", link: "page4.html" },
            { src: "img/salmon.jpg", alt: "Salmon", link: "page5.html" },
            { src: "img/pecan.jpg", alt: "Pecan", link: "page6.html" }
        ],
        [
            { src: "img/scarlet.jpg", alt: "Scarlet", link: "page7.html" },
            { src: "img/soot.jpg", alt: "Soot", link: "page8.html" }
        ]
    ];
