...
<header>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/dressingunit1.jpg" alt="Interior Design">
    </section>

    <!-- Scrollable Section -->
    <section class="gallery">
        <h2>Dressing Unit</h2>
        <p>Dressing units are an essential part of the bedroom interior, it often comes integrated into the wardrobes. Interior Solutions offers you the choice to build as per your requirements in custom style and measurements. Customers can get the dressing table as per your requirements anywhere in South India as part of your bedroom interior.</p>
        
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/fawn.jpg" alt="Fawn"><span>Fawn</span></a>
            <a href="page2.html" class="image-box"><img src="img/almond.jpg" alt="Almond"><span>Almond</span></a>
            <a href="page3.html" class="image-box"><img src="img/amethyst1.jpg" alt="Amethyst"><span>Amethyst</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/fulvous.jpg", alt: "Fulvous", link: "page4.html" },
            { src: "img/bisque.jpg", alt: "Bisque", link: "page5.html" },
            { src: "img/calamansi.jpg", alt: "Calamansi", link: "page6.html" }
        ]
    ];
