...
<body>
    ...
    <!-- Full-screen image -->
    <section class="hero">
        <img src="img/shoe.jpg" alt="Interior Design">
    </section>
    ...
    <section class="gallery">
        ...
        <div class="image-grid" id="imageGrid">
            <a href="page1.html" class="image-box"><img src="img/clove.jpg" alt="Clove"><span>Clove</span></a>
            <a href="page2.html" class="image-box"><img src="img/anise.jpg" alt="Anise"><span>Anise</span></a>
            <a href="page3.html" class="image-box"><img src="img/savoy.jpg" alt="Savoy"><span>Savoy</span></a>
        </div>
    ...
    const newImagesSet = [
        [
            { src: "img/paprika.jpg", alt: "Paprika", link: "page4.html" },
            { src: "img/sesame.jpg", alt: "Sesame", link: "page5.html" },
            { src: "img/caramel.jpg", alt: "Caramel", link: "page6.html" }
        ],
        [
            { src: "img/ajwain.jpg", alt: "Ajwain", link: "page7.html" },
            { src: "img/peridot.jpg", alt: "Peridot", link: "page8.html" },
            { src: "img/cassia.jpg", alt: "Cassia", link: "page9.html" }
        ],
        [
            { src: "img/fenugreek.jpg", alt: "Fenugreek", link: "page7.html" },
            { src: "img/tulip.jpg", alt: "Tulip", link: "page8.html" },
            { src: "img/geranium.jpg", alt: "Geranium", link: "page9.html" }
        ]
    ];
